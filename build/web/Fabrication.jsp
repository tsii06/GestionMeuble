...
<%
    ...
    Vector<Metier> metier = (Vector<Metier>) request.getAttribute("listeMetier");
    ...
    <div class="row">
      ...
      <div class="col-md-9">
          ...
          <div class="panel panel-default cover">             
              <form action="InsertFabrique" method="get">
                  <h1>Main d'oeuvre</h1>
                  <div class="form-group">
                                <label class="input-group-text" for="matiere">Meuble</label>
                            ...
                            <div class="input-group mb-3 ">
                                <label class="input-group-text" for="qte">Prix de vente</label>
                                <input type="number" name="vente" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                           </div>
                       
                    <div class="row " id="dd">
                        <div class=" col-lg-4">
                            <label class="input-group-text" for="matiere">Metier</label>
                              <select class="form-control" id="diplome" name="metier">
                                <% for(int i=0;i<metier.size();i++) { %>
                                    <option value=<%= metier.get(i).getIdMetier()%>><%= metier.get(i).getNom() %></option>
                                <% } %>
                            </select>
                        </div>
                        <div class=" col-lg-4">
                        ...
                        <div class=" col-lg-4">
                            <div class="input-group mb-3 ">
                                <label class="input-group-text" for="qte">Heure</label>
                                <input type="number" name="heure" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                           </div>
                        </div>
                    </div>
...
var dd = document.getElementById("dd");
        ...
        <div class="row">
                        ...
                        <div class=" col-lg-4">
                            <div class="input-group mb-3 ">
                                <label class="input-group-text" for="quantite">Heure</label>
                                <input type="number" name="heure" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
                           </div>
                        </div>
                    </div>
